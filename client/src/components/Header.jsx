    ...
    <header className="bg-blue-300  shadow-md">
      <div className="flex justify-between items-center max-w-6xl mx-auto p-3">
        ...
        <form
          ...
          className=" bg-blue-100 rounded-lg p-3 flex items-center active:shadow-lg  "
        >
          <input
            type="text"
            placeholder="Search..."
            className="bg-transparent focus:outline-none w-24 sm:w-64 active:border-blue-900 "
            value={searchTerm}
