  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4'onSubmit={handleSubmit} >
        <input onChange={(e)=>setFile(e.target.files[0])} type="file"  className='' hidden accept='image/*'  ref={fileRef} id="" />
        ...
        <p className='text-sm self-center'>{fileUpladError? ( 
...
<Link to={"/create-listing"} className='bg-green-800 text-white rounded-lg p-3 uppercase text-center hover:opacity-95'>
  Create Listing
</Link >
      </form>
